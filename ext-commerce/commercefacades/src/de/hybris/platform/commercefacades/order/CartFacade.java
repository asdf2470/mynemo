...
public interface CartFacade
{
	 ...
	 * @return
	 */
	abstract List<PriceOverrideReasonCodeModel> findReasonCodes();

	/**
	 * Telesales method for price override in cart
	 * @param entryNumber
	 * @param newPrice
	 * @param pk
	 * @param reasonText
	 ...
	 * @throws CommerceCartModificationException
	 */
	abstract PriceOverrideModel updateCartEntryTotalPrice(long entryNumber, Double newPrice, Integer reasonNum, String reasonText)
			throws CommerceCartModificationException;
