...
<%@ taglib prefix="ts" tagdir="/WEB-INF/tags/desktop/ts" %>
					...
					<td headers="header4" class="quantity">
						...
						<form:form id="updateCartForm${entry.entryNumber}" action="${cartUpdateFormAction}" method="post" 
							...
							<ycommerce:testId code="cart_product_quantity">
								...
								<form:input disabled="${not entry.updateable}" type="text" size="1" id="quantity${entry.entryNumber}" class="qty" 
									path="quantity" />
							</ycommerce:testId>
